...
export class Convert {
    public static toOneCharacter(json: string): OneCharacter {
        return cast(JSON.parse(json), r("OneCharacter"));
    }

    public static oneCharacterToJson(value: OneCharacter): string {
        return JSON.stringify(uncast(value, r("OneCharacter")), null, 2);
    }
}
